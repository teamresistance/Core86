...
public class JoystickIO {
    //These are placeholder ports, replace them with the joystick port and button number in the object instantiation/declaration
	...
	//ArrayList of Buttons so that it is much easier to update all of the buttons in the update() method through a for loop
	private static ArrayList<Button> buttons = new ArrayList<>();

	//Actual Buttons, usually seperated by which subsystem they are part of or sorted by their use for readability
