package org.teamresistance.core.mathi;

import org.teamresistance.core.configuration.Configurable;
import org.teamresistance.core.mathf.Quaternionf;
import org.teamresistance.core.mathf.Vector3f;
...
public class Vector3i {
    ...
    public Vector3i sub(Vector3f r) {
        return new Vector3i(x - (int) r.getX(), y - (int) r.getY(), z - (int) r.getZ());
    }
    ...
    public Vector3i mod(Vector3i r) {
        return new Vector3i(getX() % r.getX(), getY() % r.getY(), getZ() % r.getZ());
    }
