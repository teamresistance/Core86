...
public class Time {
     ...
     * 
     * <p>
     * The first invocation of this function <b>may</b> not result in an expected
     * value.
     */
    ...
    /**
     * Returns the amount of time passed in seconds between the previous two
     * successive calls to {@link #update()}.
     * 
     ...
     * nanoseconds since some fixed but arbitrary <i>origin</i> time (perhaps in the
