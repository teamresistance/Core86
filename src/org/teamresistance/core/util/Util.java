...
public class Util {
     ...
     *            value to be scaled
     * @param inLo
     *            lower bound for the input range
     * @param inHi
     *            upper bound for the input range
     * @param outLo
     *            lower bound for the output range
     * @param outHi
     *            upper bound for the output range
    ...
    public static double scaleInput(double input) {
        double[] scaleArray = { 0.0, 0.16, 0.18, 0.20, 0.24, 0.28, 0.32, 0.36, 0.40, 0.45, 0.50, 0.55, 0.62, 0.72, 0.85,
                1.00, 1.00 };
