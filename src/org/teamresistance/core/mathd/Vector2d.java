...
public class Vector2d implements LiveWindowSendable {
     ...
     * 
     * @param a
     *            default value for all dimensions.
     */
    ...
    /**
     * Performs componentwise addition of this and another vector and returns the
     ...
     * @param r
     *            other vector
     * @return the new vector equal to the componentwise sum of this and another
     *         vector
     */
    ...
    /**
     * Performs componentwise addition of this and another vector with components x
     * and y and returns the result as a new vector.
     * 
     * <pre>
     * <code>
     * Vector2d n = new Vector2d(1.0, 2.0);
     ...
     * 
     * @param x
     *            x component of other vector
     * @param y
     *            y component of other vector
     * @return the new vector equal to the componentwise sum of this and another
     *         vector
     */
    ...
    /**
     * Adds a value to all components of the vector and returns the result as a new
     * vector
     * 
     * <pre>
     * <code>
     ...
     * 
     * @param r
     *            value added to all components of this vector
    ...
    /**
     * Performs componentwise subtraction of this and another vector and returns the
     * result as a new vector.
     * 
     * <pre>
     * <code>
     ...
     * @param r
     *            other vector
     * @return the new vector equal to the componentwise difference of this and
     *         another vector
     */
    ...
    /**
     * Performs componentwise subtraction of this and another vector with components
     * x and y and returns the result as a new vector.
     * 
     * <pre>
     * <code>
     * Vector2d n = new Vector2d(1.0, 2.0);
    ...
    /**
     * Subtracts a value from all components of the vector and returns the result as
     * a new vector
     * 
     * <pre>
     * <code>
     ...
     * 
     * @param r
     *            value subtracted from all components of this vector
     * @return a new vector with r added to all components
     */
    ...
    /**
     * Performs componentwise multiplication of this and another vector and returns
     * the result as a new vector.
     * 
     * <p>
     * NOTE: this is not a valid form of multiplication within linear algebra
     * 
     * <pre>
     * <code>
     * Vector2d n = new Vector2d(1.0, 2.0);
     ...
     * @param r
     *            other vector
     * @return the new vector equal to the componentwise multiplication of this and
     *         another vector
     */
    ...
    /**
     * Performs componentwise multiplication of this and another vector with
     * components x and y and returns the result as a new vector.
     * 
     * <p>
     * NOTE: this is not a valid form of multiplication within linear algebra
     * 
     ...
     * 
     * @param r
     *            value multiplied by all components of this vector
    ...
    /**
     * Performs componentwise division of this and another vector and returns the
     * result as a new vector.
     * 
     * <p>
     * NOTE: this is not a valid within linear algebra
     * 
     * <pre>
     * <code>
     * Vector2d n = new Vector2d(1.0, 2.0);
     ...
     * @param r
     *            dividend
     * @return the new vector equal to the componentwise quotients of this and
     *         another vector
     */
    ...
    /**
     * Performs componentwise division of this and another vector with components x
     * and y and returns the result as a new vector.
     * 
     * <p>
     * NOTE: this is not a valid within linear algebra
     ...
     * @param y
     *            y component of other vector
     * @return the new vector equal to the componentwise division of this and
     *         another vector
     */
    ...
    /**
     * Scales this vector by the reciprocal of a value and returns the result as a
     * new vector.
     * 
     * <pre>
     * <code>
    ...
    /**
     * Returns a new vector with components equal to the absolute value of the
     * components of this vector.
     * 
     * @return a new vector with components equal to the absolute value of the
     *         components of this vector
     */
    public Vector2d abs() {
    ...
    /**
     * Returns true if all corresponding components of this and another vector are
     * equal.
     * 
     * @param r
     *            other vector
    ...
    /**
     * Returns a new vector with components in the order given by the name of the
     * vector.
     * 
     * <pre>
